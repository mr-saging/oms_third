...
<head>
  ...
  <title>FoodsOUT | User Login</title>
  ...
  <div class="login-container">
    ...
    <div class="login-right">
      <div class="login-box">
        ...
        <form action="<?php echo site_url('PagesController/login_validation'); ?>" method="post">
        ...
        <div class="bottom-text">
          Don’t have an account? <a href="<?php echo site_url('PagesController/registration_user'); ?>">Sign up</a>
        </div>
      </div>
    </div>
  </div>
